  ...
  return (
    <>
      <Switch>
        ...
        <Route path="/retrieveAccount/:email/:token">
          <OpenedEmail />
        </Route>
        <Route path="/activateAccount/:email/:token">
          <ActivateAccount />
        </Route>
     {loginState==="success" ? 
...
function Forgot() {
  ...
  function sendEmail() {
    fetch("https://urlshortener-ranjith.herokuapp.com/users/forgot", {
      method: "POST",
...
function OpenedEmail() {
  ...
  function getMessage() {
    fetch(`https://urlshortener-ranjith.herokuapp.com/retrieveAccount/${email}/${token}`, {
      method: "GET",
    })
      .then((data) => data.json())
      .then((userdata) => setMessage(userdata.message));
  ...
  function updatePassword() {
    fetch(`https://urlshortener-ranjith.herokuapp.com/resetPassword/${email}/${token}`, {
      method: "PUT",
...
function SignUp() {
  ...
  function checkEmail() {
    fetch("https://urlshortener-ranjith.herokuapp.com/data", {
      method: "POST",
      body: JSON.stringify({ email: email }),
      headers: {
        "Content-Type": "application/json",
  ...
  function createAccount() {
    fetch("https://urlshortener-ranjith.herokuapp.com/users/SignUp", {
      method: "POST",
...
function ActivateAccount() {
  ...
  const [message, setMessage] = useState('waiting');
  function getMessage() {
    fetch(`https://urlshortener-ranjith.herokuapp.com/activateAccount/${email}/${token}`, {
      method: "PUT",
    })
      .then((data) => data.json())
      .then((userdata) => setMessage(userdata.message));
...
function Login() {
  ...
  function loginAccount() {
    fetch("https://urlshortener-ranjith.herokuapp.com/users/Login", {
      method: "POST",
...
function UrlDashboard() {
  ...
  function monthlyData() {
    fetch("https://urlshortener-ranjith.herokuapp.com/urlGraph/monthly", {
      method: "GET",
    })
      .then((data) => data.json())
  ...
  function dailyData(month) {
    fetch(`https://urlshortener-ranjith.herokuapp.com/urlGraph/daily/${month}`, {
      method: "GET",
    })
      .then((data) => data.json())
      .then((urldata) => setUrlsData(urldata))
...
function UrlShortener() {
  ...
  function getShortUrl() {
    fetch("https://urlshortener-ranjith.herokuapp.com/shortUrl", {
      method: "POST",
